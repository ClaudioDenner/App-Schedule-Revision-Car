...
export default function DialogAlertSchedule({nId}:any){
    ...
    async function deleteClient(){
        ...
        .then((res)=>{
           if(res.status === 200){
            toastSuccess();
            setTimeout(()=> router.push('/fallback/schedules'), 2500)
    ...
    return(
        <>
            ...
            <AlertDialog.Content style={{ maxWidth: 450 }}>
                ...
                Você está prestes a remover permanentemente o Agendamento nº<b> #{nId}</b>, tem certeza?
